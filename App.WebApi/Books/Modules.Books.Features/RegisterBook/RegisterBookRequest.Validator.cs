...
namespace Modules.Books.Features.RegisterBook
{
    public class RegisterBookRequestValidator : AbstractValidator<RegisterBookRequest>
    {
        public RegisterBookRequestValidator() 
        {
            ...
            RuleFor(book => book.Author).NotEmpty().WithMessage("Author name cannot be empty.")
            ...
            RuleFor(book => book.Publisher).NotEmpty().WithMessage("Publisher name cannot be empty.")
                .MinimumLength(3).WithMessage("Publisher name must be at least 3 characters long.")
                .MaximumLength(100).WithMessage("Publisher name cannot exceed 100 characters.");

            RuleFor(book => book.Description).NotEmpty().WithMessage("Description cannot be empty.")
